...
5. **2:20–2:50 — Sponsor workflow and safety.** Only if credentials have been configured and an end-to-end run passes, demonstrate a real Firecrawl/OpenAI pre-screen and AgentMail request/reply. Otherwise explicitly say these are wired but not live-tested. Finish with the safety boundary: no AI or demo status grants permission to cut.
...
- [ ] Configure and verify live Firecrawl, OpenAI, and AgentMail accounts. Current deployment has no known sponsor credentials.
